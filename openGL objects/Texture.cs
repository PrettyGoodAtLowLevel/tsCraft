...
namespace OurCraft
{
    public class Texture
    {
        ...
        public bool Load(string filename, TextureUnit unit = TextureUnit.Texture0)
        {
            ...
            StbImage.stbi_set_flip_vertically_on_load(1); //get correct orientation
            ...
            //upload to OpenGL
            GL.TexImage2D(TextureTarget.Texture2D, 0, PixelInternalFormat.SrgbAlpha, image.Width, image.Height, 0,
