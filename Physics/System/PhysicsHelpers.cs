    ...
    public static class PhysicsHelpers
    {
        ...
        public static bool BoxCollidesWorld(ChunkManager world, AABB box)
        {
            ...
            for (int z = minZ; z <= maxZ; z++)
            {
                ...
                {
                    if (AABBHelpers.IntersectsLocal(aabb, box, new Vector3d(x, y, z), Vector3d.Zero)) return true; //collision found
                }
            }
        ...
        public static double GetGroundBounciness(ChunkManager world, PhysicsObj body, Vector3d pos)
        {
            ...
            AABB rbBox = AABBHelpers.GetAABB(pos, body.boundsMin, body.boundsMax);
        ...
        {
            AABB rbBox = AABBHelpers.GetAABB(body.position, body.boundsMin, body.boundsMax);
