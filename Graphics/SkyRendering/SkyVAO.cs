...
namespace OurCraft.Graphics.SkyRendering
{
    public class SkyVAO
    {
        ...
        public void LinkAttrib(SkyVBO vbo, int layout, int numComponents, VertexAttribPointerType type, bool normalize, int stride, IntPtr offset)
        {
            vbo.Bind();
        ...
        public void LinkAttribInt(SkyVBO vbo, int layout, int numComponents, VertexAttribIntegerType type, int stride, IntPtr offset)
        {
            vbo.Bind();
