...
namespace OurCraft.Graphics
{
    ...
    public class BlockVAO
    {
        ...
        public void LinkAttrib(BlockVBO vbo, int layout, int numComponents, VertexAttribPointerType type, bool normalize, int stride, IntPtr offset)
        {
            vbo.Bind();
        ...
        public void LinkAttribInt(BlockVBO vbo, int layout, int numComponents, VertexAttribIntegerType type, int stride, IntPtr offset)
        {
            vbo.Bind();
